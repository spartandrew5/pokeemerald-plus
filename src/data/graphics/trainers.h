...
const u32 gTrainerFrontPic_Sky[] = INCBIN_U32("graphics/trainers/front_pics/sky.4bpp.smol");
const u16 gTrainerPalette_Sky[] = INCBIN_U16("graphics/trainers/front_pics/sky.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_SKY, gTrainerFrontPic_Sky, gTrainerPalette_Sky),
};
